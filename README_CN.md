...
| 容器与 OCI           | Docker Hub、GitHub Container Registry、GitLab Container Registry、Quay、Kubernetes Registry、GCR、Microsoft MCR、Elastic Registry、NVIDIA NVCR、Oracle Container Registry、Homebrew OCI                                                                                                                        |
