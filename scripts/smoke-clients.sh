...
enabled_proxies = ["github", "composer", "oci", "npm", "go", "crates", "pypi", "cpan", "rubygems", "maven", "nuget", "cran"]
...
printf 'client smoke passed: git npm yarn pnpm go cargo pip cpanm rubygems maven nuget cran composer%s\n' \
